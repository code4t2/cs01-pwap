public class GreatCircle {
    ...
    public static void main(String[] args) {
        ...
        double val1 = Math.sin((x2 - x1) / 2), val2 = Math.pow(val1, 2), val3 = Math.sin((y2 - y1) / 2), val4 = Math.pow(val3, 2), val5 = Math.cos(x1) * Math.cos(x2) * val4, root = val2 + val5, distance = 2 * r * Math.asin(Math.sqrt(root));
